...
This folder contains screenshots from my reverse shell exercise completed during the DVWA Command Injection lab.

## What the Screenshots Show

The screenshots show the process of establishing a reverse shell connection and upgrading it to a more interactive terminal within my controlled lab environment.
